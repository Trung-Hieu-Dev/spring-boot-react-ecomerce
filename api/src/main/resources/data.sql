...
VALUES ('Superman: Action Comics Volume 5: The House of Kentn',
        'The House of Kent, Superman, Superboy, Supergirl, the Legion of Super-Heroes’ Brainiac 5, and Young Justice’s Conner Kent must all unite to face an enemy from another dimension unleashed by the Invisible Mafia! This kind of power can lay waste to an entire family of super-people! All of this plus the future of the Daily Planet revealed!',
        'BOOK-COMIC-1000.jpg', 100, 12.99, NOW(), 1, 'Brian Michael Bendis');

INSERT INTO product (name, description, image_url, units_in_stock, unit_price, date_created, category_id, brand)
VALUES ('Batman: The Silver Age Omnibus Vol. 1',
        'The Caped Crusader is known for protecting the streets of Gotham from the villains who wish to cause harm. Follow along on some of his most adventurous tales in Batman: The Silver Age Omnibus Vol. 1 collecting Batman #101-116',
...
INSERT INTO product (name, description, image_url, units_in_stock, unit_price, date_created, category_id, brand)
VALUES ('The Art of Computer Programming',
...
INSERT INTO product (name, description, image_url, units_in_stock, unit_price, date_created, category_id, brand)
VALUES ('Python Programming for Beginners : The Ultimate Guide for Beginners',
...
INSERT INTO product (name, description, image_url, units_in_stock, unit_price, date_created, category_id, brand)
VALUES ('The Self-Taught Programmer: The Definitive Guide to Programming',
        'This book is not just about learning to program; although you will learn to code. If you want to program professionally, it is not enough to learn to code; that is why, in addition to helping you learn to program, I also cover the rest of the things you need to know to program professionally that classes and books do not teach you. "The Self-taught Programmer" is a roadmap,
...
INSERT INTO product (name, description, image_url, units_in_stock, unit_price, date_created, category_id, brand)
VALUES ('Computer Programming : The Bible : Learn from the basics to advanced ', ' Are you ready to learn and start
...
INSERT INTO product (name, description, image_url, units_in_stock, unit_price, date_created, category_id, brand)
VALUES ('Effective C : An Introduction to Professional C Programming', 'Effective C will teach you how to write
        professional, secure, and portable C code that will stand the test of time and help strengthen the foundation of
        the computing world.',
        'BOOK-PROGRAMMING-1008.jpg ', 100, 35.01, NOW(), 4, 'Robert C.Seacord');

INSERT INTO product (name, description, image_url, units_in_stock, unit_price, date_created, category_id, brand)
VALUES ('Head First Design Patterns : Building Extensible and Maintainable OOP', 'If you have read a Head First book, you know what to expect: a visually rich format designed for the way your brain works. With Head First Design Patterns, 2E you will
        learn design principles and patterns in a way that wont put you to sleep, so you can get out there to solve software design problems and speak the language of patterns with others on your team.',
        'BOOK-PROGRAMMING-1009.jpg', 100, 32.43, NOW(), 4, 'Elisabeth Robson and Eric Freeman');

INSERT INTO product (name, description, image_url, units_in_stock, unit_price, date_created, category_id, brand)
VALUES ('Beginning Programming All-in-One Desk Reference For Dummies',
